import { evaluateWord, generateFeedback as generatePhonemeFeedback } from './tagalogPhonetics';
...
export const compareReadingText = (expectedText = '', spokenText = '') => {
  ...
  ops.forEach((op) => {
    ...
    if (best.score >= 0.82) {
      ...
      if (best.score < 0.96) {
        pronunciationIssues.push({ expected: displayWord, spoken: best.word, message: generatePhonemeFeedback(phoneme, displayWord) });
      }
      return;
    }
