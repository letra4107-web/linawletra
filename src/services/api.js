...
export const scheduleService = {
  ...
  getParentCalendar: (params) => axiosInstance.get('/schedules/parent/calendar', { params }),
...
export const adminService = {
  ...
  getStudentReport: (studentId) => axiosInstance.get(`/admin/reports/students/${studentId}`),
  downloadStudentReportPdf: (studentId) => axiosInstance.get(`/admin/reports/students/${studentId}/pdf`, { responseType: 'blob' }),
  ...
  getArchivedUsers: () => axiosInstance.get('/admin/archive/users'),
  restoreUser: (id) => axiosInstance.post(`/admin/users/${id}/restore`),
